    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-foreground mt-2">
          Select the track that matches your goals. This will customize your quests and mentor
          recommendations.
        </p>
      </div>
      ...
      {selectedTrack && <TrackDetails track={TRACKS[selectedTrack]} />}
    </div>
  )
}
  ...
  return (
    ...
    >
      <CardHeader className="text-center">
        <div className="mb-2 text-4xl">{track.icon}</div>
      ...
      <CardContent>
        <div className="space-y-3">
          <div>
            <h4 className="mb-2 text-sm font-medium">Key Goals:</h4>
...
export async function updateUserTrack(userId: string, newTrack: string) {
  // Update user profile
  await db.update(profilesTable).set({ track: newTrack }).where(eq(profilesTable.userId, userId))
    ...
    <Card>
      ...
      <CardContent>
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <h3 className="mb-3 font-semibold">Goals & Outcomes</h3>
          ...
          <div>
            <h3 className="mb-3 font-semibold">Quest Types</h3>
            ...
            <h3 className="mb-3 mt-4 font-semibold">Mentor Expertise</h3>
            <div className="flex flex-wrap gap-2">
