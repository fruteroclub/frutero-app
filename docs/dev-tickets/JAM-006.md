...
├── users/
│   ├── route.ts          # GET users, POST user
│   └── [id]/route.ts     # GET, PUT, DELETE user
├── projects/
│   ├── route.ts          # GET projects, POST project
│   └── [id]/route.ts     # GET, PUT project
├── quests/
│   ├── route.ts          # GET quests
│   └── [id]/
│       ├── route.ts      # GET quest details
│       └── submit/route.ts # POST submission
├── programs/
│   ├── route.ts          # GET programs
│   └── [id]/
│       ├── route.ts      # GET program
│       └── join/route.ts # POST join program
├── mentors/
│   ├── route.ts          # GET mentors
│   └── connect/route.ts  # POST mentor request
└── posts/
